    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="manage.html">Back to Administrator</a>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="well">
                            ...
                            <span class="pull-right"><button><a class="glyphicon glyphicon-trash" href = "delete/{{$tag->hashtag}}" onCLick="return confirm('Are you sure you want to delete this hashtag?')" ></button></a></span>  
                        </div>
