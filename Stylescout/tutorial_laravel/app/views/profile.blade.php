        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li>
						<a class="glyphicon glyphicon-upload" href="upload.html">  </a>
					</li>
                    
					<li>
						<a class="glyphicon glyphicon-log-out" href="index.html"> Signout </a>
					</li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p>Fashion Blogger ,Photographer contact me info@andytorres.blablabla</p>
                <h3>Details</h3>
                <ul>
                    <li>Lorem Ipsum</li>
